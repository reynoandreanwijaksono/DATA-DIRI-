        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 space-y-12">
            ...
            <div class="flex items-center justify-between">
                <nav class="flex items-center space-x-2 text-xs sm:text-sm text-slate-500 dark:text-slate-400 font-medium">
                    <a href="{{ url('/') }}" class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Home</a>
                    <span>/</span>
                    <a href="{{ url('/#projects') }}" class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Projects</a>
                    <span>/</span>
                ...
                <a 
                    href="{{ url('/#projects') }}" 
                    class="inline-flex items-center text-xs sm:text-sm font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 transition-colors"
                >
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <span class="px-3.5 py-1 rounded-full bg-blue-50 dark:bg-blue-950/60 text-blue-700 dark:text-blue-300 text-xs font-bold uppercase tracking-wider">
                ...
                <div class="flex flex-wrap items-center gap-4 pt-2">
                    @if($project->live_url)
                        <a 
                            ...
                            class="inline-flex items-center px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm shadow-md shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-200 group"
                        >
                            <span>Live Demo</span>
                    ...
                    @if($project->github_url)
                        ...
                        >
                            <svg class="w-4 h-4 mr-2 fill-current text-slate-700 dark:text-slate-300 group-hover:text-blue-600 dark:group-hover:text-blue-400" viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    @foreach($project->metrics as $metric)
                        <div class="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm text-center">
                            <span class="block text-3xl font-extrabold text-blue-600 dark:text-blue-500">
                                {{ $metric['value'] }}
                            </span>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div class="lg:col-span-8 space-y-10">
                    ...
                    <div class="p-7 sm:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-4">
                        <div class="flex items-center space-x-2.5 text-blue-600 dark:text-blue-400">
                    ...
                    @if($project->solution)
                        <div class="p-7 sm:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-4">
                            <div class="flex items-center space-x-2.5 text-emerald-600 dark:text-emerald-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <ul class="space-y-2.5 pt-1 text-sm text-slate-600 dark:text-slate-300">
                                @foreach($project->results as $result)
                                    <li class="flex items-start space-x-2.5">
                                        <div class="w-1.5 h-1.5 rounded-full bg-blue-600 shrink-0 mt-2"></div>
                                        <span>{{ $result }}</span>
                                    </li>
                                @endforeach
                            </ul>
                ...
                <div class="lg:col-span-4 space-y-6">
                        ...
                        <div class="pt-2 border-t border-slate-100 dark:border-slate-800">
                            ...
                            <div class="flex flex-wrap gap-1.5">
                                @foreach($project->technologies ?? [] as $tech)
                                    <span class="px-2.5 py-1 rounded-md bg-blue-50 dark:bg-blue-950/50 text-blue-700 dark:text-blue-300 text-xs font-semibold">
                                        {{ $tech }}
                                    </span>
                                @endforeach
                            </div>
                    ...
                    <!-- Work Together CTA Box -->
                    <div class="p-6 rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-700 text-white shadow-md space-y-4">
                        ...
                        <a 
                            href="{{ url('/#contact') }}" 
                            class="inline-flex items-center justify-center w-full px-4 py-2.5 rounded-xl bg-white text-blue-700 font-bold text-xs hover:bg-blue-50 transition-colors shadow-sm"
                        >
                            Get in Touch
                        </a>
                    </div>
            ...
            <div class="pt-12 border-t border-slate-200/80 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
                @if($prevProject)
                    <a 
                        ...
                        class="w-full sm:w-auto p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700 shadow-xs flex items-center space-x-3 group transition-all"
                    >
                        ...
                        <div>
                            ...
                            <span class="block text-sm font-bold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400">{{ $prevProject->title }}</span>
                        </div>
                    </a>
                @endif
                ...
                @if($nextProject)
                    <a 
                        ...
                        class="w-full sm:w-auto p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700 shadow-xs flex items-center justify-end space-x-3 group transition-all text-right ml-auto"
                    >
                        <div>
                            <span class="block text-[10px] font-bold uppercase tracking-wider text-slate-400">Next Project</span>
                            <span class="block text-sm font-bold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400">{{ $nextProject->title }}</span>
                        </div>
                        <svg class="w-5 h-5 text-slate-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
