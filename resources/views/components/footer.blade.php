    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 space-y-8">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6 pb-6 border-b border-slate-100 dark:border-slate-900">
            ...
            <div class="flex flex-col sm:flex-row items-center sm:items-start space-y-2 sm:space-y-0 sm:space-x-3 text-center sm:text-left">
                <a href="{{ url('/') }}#home" class="text-xl font-extrabold text-slate-900 dark:text-white font-sans">
                    RA<span class="text-blue-600">.</span>
                </a>
            ...
            <div class="flex flex-wrap items-center justify-center gap-4 text-xs font-medium">
                <a 
                    ...
                    class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center space-x-1.5"
                >
                ...
                <a 
                    ...
                    class="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center space-x-1.5"
                >
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 dark:text-slate-400">
            ...
            <div class="flex items-center space-x-4">
                <a href="{{ url('/#home') }}" class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Home</a>
                <a href="{{ url('/#about') }}" class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">About</a>
                <a href="{{ url('/#skills') }}" class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Skills</a>
                <a href="{{ url('/#projects') }}" class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Projects</a>
                <a href="{{ url('/#contact') }}" class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Contact</a>

                <button 
                    type="button"
                    onclick="window.scrollTo({ top: 0, behavior: 'smooth' })" 
                    aria-label="Back to Top"
                    class="p-2 rounded-xl bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-slate-800 transition-colors"
                >
